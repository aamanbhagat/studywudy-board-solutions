...
const CASES = Object.freeze([
  ...
  Object.freeze({
    name: "lead-shot source correction remains quarantined",
    pathname: "/cbse/class-10/mathematics/rd-sharma-mathematics-class-10/surface-areas-and-volumes/questions/q-cbse-rd-sharma-mathematics-class-10-14-010",
    surface: "atomic",
    contains: /66 cm.*42 cm.*21 cm|1500 spherical lead shots/su,
    excludes: /dimensions 6 cm, 42 cm and 21 cm|136\s*4\/11/u,
    noindex: true,
  }),
  Object.freeze({
    name: "coin source correction remains quarantined",
    pathname: "/cbse/class-10/mathematics/rd-sharma-mathematics-class-10/surface-areas-and-volumes/questions/q-cbse-rd-sharma-mathematics-class-10-14-019",
    surface: "atomic",
    contains: /11 cm.*10 cm.*7 cm|1600 coins/su,
    excludes: /cuboid\s+11\s*cm\s*[×x]\s*10\s*cm\s*[×x]\s*75\s*cm|17142\s*6\/7/iu,
    noindex: true,
  }),
  Object.freeze({
    name: "probability source correction remains quarantined",
    pathname: "/cbse/class-10/mathematics/rd-sharma-mathematics-class-10/probability/questions/q-cbse-rd-sharma-mathematics-class-10-16-125",
    surface: "atomic",
    contains: /100 red cards.*200 yellow cards.*50 blue cards/su,
    excludes: /\b(?:loo|l00|I00)\b|Interpreting|apparent typo/iu,
    noindex: true,
  }),
  Object.freeze({
    name: "lead-shot near-duplicate peer is quarantined",
    pathname: "/cbse/class-10/mathematics/ncert-exemplar-mathematics-exemplar-class-10/surface-areas-and-volumes/questions/q-cbse-ncert-exemplar-mathematics-exemplar-class-10-12-039",
    surface: "atomic",
    noindex: true,
  }),
  Object.freeze({
    name: "coin near-duplicate peer is quarantined",
    pathname: "/maharashtra-board/class-10/mathematics/scert-maharashtra-geometry-mathematics-2-standard-10/mensuration/questions/q-msb-scert-maharashtra-geometry-mathematics-2-standard-10-7-041",
    surface: "atomic",
    noindex: true,
  }),
  Object.freeze({
